...
import type { FiscalDriver, FiscalRequest, FiscalResult } from './pay.ts';
...
export class ReKassaDriver implements FiscalDriver {
  type = 'rekassa';
  cfg: { baseUrl: string; cashboxNumber: string; token: string };
  fetchImpl: typeof fetch;
  constructor(cfg: { baseUrl: string; cashboxNumber: string; token: string }, fetchImpl: typeof fetch = fetch) {
    this.cfg = cfg; this.fetchImpl = fetchImpl;
  }
