...
import { inventoryDiff } from './stock.ts';
  ...
  return (
    <div className="inv-screen">
      <header className="doc-head">
        ...
        <span className="inv-note">Точка отсчёта: {props.startedAt}. Продажи можно не останавливать.</span>
      </header>
      ...
      <footer className="doc-foot">
        <span className="shortage">Недостача: <b>{fmt(t.shortageMoney)}</b></span>
